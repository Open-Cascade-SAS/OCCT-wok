...
#mkdir -p $installRelatePath/site/WokConfig.app/
#mkdir -p $installRelatePath/site/WokEmacs.app/
...
cp -f src/WOKTclLib/templates/env.sh $installRelatePath/lib/templates/
cp -f src/WOKTclLib/templates/draw.sh $installRelatePath/lib/templates/
cp -f src/WOKTclLib/templates/codeblocks.sh $installRelatePath/lib/templates/
cp -f src/WOKTclLib/templates/build_configure $installRelatePath/lib/templates/
cp -f src/WOKTclLib/templates/custom.sh.in $installRelatePath/lib/templates/
cp -f src/WOKTclLib/templates/acinclude.m4 $installRelatePath/lib/templates/
cp -f src/WOKTclLib/templates/template.mam $installRelatePath/lib/templates/
cp -f src/WOKTclLib/templates/template.mamx $installRelatePath/lib/templates/
cp -f src/WOKTclLib/templates/template.ac $installRelatePath/lib/templates/
